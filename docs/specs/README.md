...
Specs designed for future versions (v1.2+).

| ID | Title | Target Version | Description |
|----|-------|----------------|-------------|
| 012 | Loop Command | v1.2+ | Iterative LLM-assisted Lean proof attempts |
...
3. **Complete** - Fully implemented and tested
4. **Archived** - Completed, locked in
