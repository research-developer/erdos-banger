...
3. **DEBT-016** (SRP) - Medium effort. Split models.py.
4. **DEBT-019** (DI) - High effort. Add dependency injection.
5. **DEBT-021** (Abstractions) - High effort. Add service layer.
...
| DEBT-020 | Magic Numbers and Naming | P3 | Fixed | (pending) |
