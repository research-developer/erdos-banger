...
This project request had uuid: 16221a46-f94f-4e70-98c2-98efaf524619
...
Unexpected axioms were added during verification: ['Erdos.Problem074.BurlingAristotle.BurlingGraphAdj_symm', 'Erdos.Problem074.BurlingAristotle.BurlingGraphAdj_loopless', 'harmonicSorry78584', 'Erdos.Problem074.BurlingAristotle.BurlingGraphAdj', 'Erdos.Problem074.BurlingAristotle.burling_chromatic_number', 'Erdos.Problem074.BurlingAristotle.burling_triangle_free']-/
...
Unknown constant `SimpleGraph.maxSubgraphEdgeDistToBipartite`
Unknown constant `SimpleGraph.maxSubgraphEdgeDistToBipartite`
`simp` made no progress
Unknown identifier `burling_1_bipartite`-/
/--
...
Invalid name after `end`: `Erdos.Problem074.BurlingAristotle` contains too many components

Hint: Use current scope name `[anonymous]`:
  e̵n̵d̵ ̵E̵r̵d̵o̵s̵.̵P̵r̵o̵b̵l̵e̵m̵0̵7̵4̵.̵B̵u̵r̵l̵i̵n̵g̵A̵r̵i̵s̵t̵o̵t̵l̵e̵e̲n̲d̲ ̲[̲a̲n̲o̲n̲y̲m̲o̲u̲s̲]̲-/
