...
SAMPLE_DOCUMENT_RESPONSE: dict[str, Any] = json.loads(
    (FIXTURES_DIR / "zbmath_responses" / "document_green_tao.json").read_text()
)

SAMPLE_SEARCH_RESPONSE: dict[str, Any] = json.loads(
    (FIXTURES_DIR / "zbmath_responses" / "search_msc_11B05.json").read_text()
)
