...
class TestErdosAsk:
    ...
    def test_ask_no_llm_json_output(
    ...
    def test_ask_no_llm_answer_is_null(
        self, cli_runner: Callable[..., subprocess.CompletedProcess[str]]
    ) -> None:
    ...
    def test_ask_no_llm_has_sources(
        self, cli_runner: Callable[..., subprocess.CompletedProcess[str]]
    ) -> None:
    ...
    def test_ask_no_llm_sources_have_schema_keys(
        self, cli_runner: Callable[..., subprocess.CompletedProcess[str]]
    ) -> None:
