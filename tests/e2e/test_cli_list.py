...
class TestErdosList:
    ...
    def test_list_json_output(self, cli_runner) -> None:
    ...
    def test_list_json_schema_keys(self, cli_runner) -> None:
    ...
    def test_list_exit_code_zero(self, cli_runner) -> None:
        """erdos list returns exit code 0 on success."""
        result = cli_runner("list", "--limit", "1")
        assert result.returncode == 0

    def test_list_filter_by_status(self, cli_runner) -> None:
